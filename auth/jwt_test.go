...
import (
	...
	"github.com/manaty226/go_todo_app/clock"
	"github.com/manaty226/go_todo_app/entity"
	"github.com/manaty226/go_todo_app/store"
	"github.com/manaty226/go_todo_app/testutil/fixture"
)
...
func TestJWTer_GetToken(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/manaty226/go_todo_app`).
